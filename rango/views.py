...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            # Update our variable to indicate that he template
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        # if we have a User object, the details are corrent.
        # if None,no user
        # with matching credentials was found.
        if user:
            # Is the account activate? it could have been disabled.
            if user.is_active:
    ...
    #The request us not a HTTP post, so display the login form
